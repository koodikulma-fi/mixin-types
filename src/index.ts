...
export type AsInstance<
    ...
    ClassType = Instance["constructor"]
> = Instance & { ["constructor"]: AsClass<ClassType, Instance, ConstructorArgs>; }
...
export type AsMixin<
    ...
    ConstructorArgs extends any[] = MixinInstance["constructor"] extends new (...args: any[]) => any ? GetConstructorArgs<MixinInstance["constructor"]> : any[]
> =
    <TBase extends ClassType>(Base: TBase) => Omit<TBase, "new"> & { new (...args: ConstructorArgs): GetConstructorReturn<TBase> & MixinInstance; };
